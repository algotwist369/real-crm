...
const EditLeadModal = ({ isOpen, onClose, onUpdate, lead }) => {
    ...
    useEffect(() => {
        if (lead && isOpen) {
            ...
            const foundCurrency = lead.currency || "AED";
            ...
            setFormData({
                ...
                built_up_area_value: lead.built_up_area?.value || "",
                built_up_area_unit: lead.built_up_area?.unit || "sq.ft",
                ...
                price_label: lead.price_label || "",
                price_negotiable: !!lead.price_negotiable,
                ...
                shared_details: lead.shared_details || "",
                // CRM
                client_type: lead.client_type || "buying",
                inquiry_for: lead.inquiry_for || "",
                source: lead.source || "website",
                priority: lead.priority || "low",
                properties: lead.properties ? lead.properties.map(p => p._id) : [],
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                    ...
                    <InputField label="Email Address" icon={FiMail}>
                        <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="client@email.com" className={inputCls} />
                    </InputField>
                </div>
                <div className="space-y-4">
        ...
        <div className="fixed inset-0 bg-zinc-950/85 z-[60] flex items-center justify-center p-4 backdrop-blur-sm">
            <div className="bg-zinc-900 border border-zinc-800 rounded-lg w-full max-w-2xl overflow-hidden shadow-2xl flex flex-col max-h-[95vh]">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800 bg-zinc-900/80 flex-shrink-0">
                    <div>
                        <h2 className="text-base font-semibold text-white">Edit Lead Profile</h2>
                        <p className="text-[11px] text-zinc-500 mt-0.5">Update lead data and requirements</p>
                    </div>
